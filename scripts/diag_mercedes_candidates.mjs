...
// Mercedes-Benz model pages, plus whether the current slug_variants config
// would match each candidate.
//
// Usage: node scripts/diag_mercedes_candidates.mjs
...
async function main() {
  ...
  // Pick from the FAILING-to-scrape models: cle-cabriolet, sl-roadster, gla-suv, glb-suv,
  // amg-gt-coupe, amg-gt-4-door-coupe, g-class, eqe-sedan, eqs-sedan, maybach-s-class
  let TARGETS;
  if (process.argv.includes("--failed")) {
    TARGETS = ["cle-cabriolet", "sl-roadster", "gla-suv", "amg-gt-coupe", "amg-gt-4-door-coupe", "g-class", "eqe-sedan", "eqs-sedan", "maybach-s-class", "maybach-gls", "maybach-eqs-suv", "glb-suv"];
  } else if (process.argv.includes("--maybach")) {
    TARGETS = ["maybach-s-class", "maybach-gls", "maybach-eqs-suv", "e-class-wagon", "cle-coupe", "gle-coupe", "glc-coupe", "amg-gt-coupe", "amg-gt-4-door-coupe"];
  } else {
    TARGETS = ["e-class-sedan", "gle-suv", "c-class", "glc-suv", "s-class"];
  }
